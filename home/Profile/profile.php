...
<body>
    <nav id="slide-menu">
        <ul>
            ...
            <li><a href="../dash/dash.html">Dashboard</a></li>
    ...
    <div id="content">
        ...
        <div class="main_cont">
            <div class="container">
                <input required="" type="text" name="text" class="input" value="<?php echo htmlspecialchars($name); ?>" >
                <label class="label">Name</label>
            </div>
            <div class="container">
                <input required="" type="text" name="email" class="input" value="<?php echo htmlspecialchars($email); ?>" >
        ...
        <div class="main_cont">
            ...
            <div class="container">
                <select name="dropdown" class="input">
                    <option value="">Select an option</option>
                    <option value="Musician">Male</option>
                    <option value="collaborator">Female</option>
                </select>
