            ...
            <div class="main_cont">
                <div class="container">
                    <select name="role" class="input">
                        ...
                        <option value="Musician" <?php echo $role == 'Musician' ? 'selected' : ''; ?>>Musician</option>
                        <option value="Collaborator" <?php echo $role == 'Collaborator' ? 'selected' : ''; ?>>Collaborator</option>
                    </select>
